...
import com.example.fabapi.placeholder.PlaceholderContent;
import com.example.fabapi.databinding.FragmentItemDetailBinding;
    ...
    private void testAllThatJazz() {
        ...
        })
        {
            ...
            public Map<String, String>getHeaders() throws AuthFailureError{
                ...
                headers.put("X-RapidAPI-Key","SIGN-UP-FOR-KEY");
                headers.put("X-RapidAPI-Host", "dad-jokes.p.rapidapi.com");
                return headers;
            }
        };
